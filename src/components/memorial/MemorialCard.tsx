...
export default function MemorialCard({
  ...
  return (
    <article className="w-full rounded-2xl border border-slate-200/90 bg-white/95 p-5 shadow-md shadow-slate-400/10 backdrop-blur transition hover:border-amber-200/60 hover:shadow-lg hover:shadow-amber-900/5">
      <div className="flex items-start justify-between gap-3">
        ...
        <Link
          href={`/memorials/${slug}`}
          className="shrink-0 rounded-xl bg-amber-700 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-amber-600"
